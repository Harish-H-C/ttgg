    ...
    return(
        <div>
            <Header6/>
                ...
                <hr/>
                <h6>Duration-Mismatched Report</h6>
...
export default DurMisDisplay;


//<td style={{'backgroundColor': dateis.Deviation === '2' ? 'green' : 'pink'}}>{dateis.Deviation}</td>