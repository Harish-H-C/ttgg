    ...
    const chart = () => {
      ...
      axios
        ...
        .then(res => {
          ...
          const dataValues = res.data.filter( dataValues => Moment(dataValues.Service_Start).format('YYYY-MM-DD') >= start_date && Moment(dataValues.Service_Start).format('YYYY-MM-DD') <= end_date).map((dataValues,index) => {
            ...
            datasets: [
              {
                ...
                data: numOfMassDone,
                backgroundColor: ["rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)",,"rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)","rgba(75, 192, 192, 0.6)"],
                borderWidth: 2
              }
            ]
          });
